...
|UI_TITLE|SIEMENS AI| Chat title (left-top) and page title (HTML)
|UI_LOGO|| Logo (left-top). Defaults to SIEMENS AI logo. Configure the URL to your logo image to modify.
|UI_CHAT_LOGO|| Logo (chat window). Defaults to SIEMENS AI logo. Configure the URL to your logo image to modify.
|UI_CHAT_TITLE|SIEMENS AI| Title (chat window)
|UI_CHAT_DESCRIPTION|CHATBOT| Description (chat window)
|UI_FAVICON|| Defaults to SIEMENS AI favicon. Configure the URL to your favicon to modify.
